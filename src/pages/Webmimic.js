            ...
            <div className={`page`} style={{overflow:"auto"}}>
                <div style={{display: 'flex', flexDirection: 'row'}}>
                    ...
                    <div className={"page-heading"} style={{
                        ...
                        <img style={{height:'40px'}} src={'https://rawcdn.githack.com/legendsayantan/WebMimic/7f790100059935a6cf05def8c54cc56416a9ae8d/extension/WebMimic/images/icon.png'} alt={''}/>
                ...
                <div className={'page-content'}>
                    ...
                    <p>
                        This android app / browser extension is a custom browser , integrated with a specific algorithm that can detect and learn what you're doing on a webpage then simulate them whenever needed.
                    </p>
                </div>
                <div className={'page-content'}>
                    <h3 >But why?</h3>
                ...
                <div style={{display:"flex",flexDirection:"row",justifyContent:"center",alignItems:"center",width:"100%"}}>
                    ...
                    <div className="button-glass" style={{display:'block',margin:'10px',padding:'5px 10px'}} onClick={()=>{
                        ...
                        <img style={{height:'50px'}} src={'https://www.freepnglogos.com/uploads/google-chrome-png-logo/google-chrome-logo-png-0.png'}/>
                    </div>
                </div>
