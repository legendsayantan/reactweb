            ...
            <div className={`page`} style={{overflow: "auto"}}>
                ...
                <section className="center"
                    ...
                    <h4 style={{
                        ...
                        alignItems: "center",
                        marginBottom: 0
                    }}>Make sure to follow these steps :</h4>
                ...
                <div style={{
                    display: (waitingForAdb) ? 'flex' : 'none',
                    flexDirection: 'row',
                    justifyContent: "center",
                    color: '#0154b4',
                    fontWeight: "bold",
                ...
                <div style={{display: 'flex', flexDirection: 'row', justifyContent: "center", alignItems: "center"}}>
                    <div className="button-glass"
                         style={{display: connected ? 'block' : 'none', margin: '0px', padding: '5px 10px'}}
                         onClick={() => {
                ...
                <section className="center"
                         style={{
                             ...
                             maxWidth: '100%',
                             alignItems: 'center',
                             display: (connected && !waitingForAdb) ? 'block' : 'none'
                         }}>
                    <h4 style={{textAlign: "center", justifyContent: "center", alignItems: "center"}}>Activate any trial
                        theme / font / wallpaper from <strong>Theme Store</strong>, then Select below.</h4>
                    <div
                        style={{display: 'flex', flexDirection: 'row', justifyContent: "center", alignItems: "center"}}>
                        <div className="button-glass"
                             style={{display: connected ? 'block' : 'none', margin: '10px', padding: '5px 10px'}}
                             onClick={() => {
