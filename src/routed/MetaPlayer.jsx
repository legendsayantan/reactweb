    ...
    return (
        <>
            <style>{`
                ...
                .playlist-sidebar h2 { font-size: 1.25rem; font-weight: bold; margin-bottom: 12px; color: #67e8f9; flex-shrink: 0; opacity: 0.8; }
                .playlist-scroll-area { flex-grow: 1; overflow-y: auto; padding-right: 8px; }
                /* Custom Scrollbar Styles */
                .playlist-scroll-area::-webkit-scrollbar, .details-card::-webkit-scrollbar { width: 8px; }
                .playlist-scroll-area::-webkit-scrollbar-track, .details-card::-webkit-scrollbar-track { background: #1f2937; border-radius: 4px; }
                .playlist-scroll-area::-webkit-scrollbar-thumb, .details-card::-webkit-scrollbar-thumb { background: #4b5563; border-radius: 4px; }
                .playlist-scroll-area::-webkit-scrollbar-thumb:hover, .details-card::-webkit-scrollbar-thumb:hover { background: #6b7280; }
                ...
                .playlist-item h4 { font-weight: bold; color: white; line-height: 1.25; font-size: 0.9rem; margin: 0; opacity: 0.8; }
                .playlist-item p { font-size: 0.8rem; color: #d1d5db; margin: 0; opacity: 0.6; }
                ...
                .description-text { color: #9ca3af; margin: 0; opacity: 0.7; }
                ...
                .expanded-details p { margin-bottom: 2px; opacity: 0.7;}
